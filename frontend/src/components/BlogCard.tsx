...
const BlogCard = ({
  ...
  return (
    <>
      <div className="border-b-[1px] border-solid border-gray-200 w-full">
        <div className="p-4  max-w-3xl  flex flex-col gap-2 hover:bg-gray-100 duration-200 cursor-pointer">
